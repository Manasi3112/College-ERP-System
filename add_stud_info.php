	...
	<div class="container px-4 py-2 px-5 text-center text-lg-start my-5">
	  <div class="row gx-lg-5 align-items-center mb-5">
		...
		<h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
			Student Details<br/>
			<span style="color: hsl(218, 81%, 75%)">Add students from your college</span>
		  </h1>
		</div>
			...
			<form  action= "add_stud_info2.php" method="POST">
			  <!-- college name -->
				<div class="form-outline mb-4">
				  <input type="number" id="form3Example3" name="stu_id" 
				...
				<div class="form-outline mb-4">
				  ...
				  class="form-control" placeholder="Enter Student Branch" required/>
				</div>

				<!-- Password input -->
				<div class="form-outline mb-4">
				  <input type="text" id="form3Example4" name= "class" 
				  class="form-control" placeholder="Enter Student Class" required/>
				</div>

				<!-- Password input -->
				<div class="form-outline mb-4">
				  <input type="text" id="form3Example4" name= "prn" 
				  class="form-control" placeholder="Enter Student PRN" required/>
				</div>
